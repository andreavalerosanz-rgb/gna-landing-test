...
<section class="w-full bg-white pt-20 pb-16 px-6 lg:px-[130px]">
  <div class="w-full max-w-[1440px] mx-auto flex flex-col items-center">
    ...
    <div class="space-y-6 text-left text-[17px] text-gray-900 leading-relaxed w-full">
      <p>
